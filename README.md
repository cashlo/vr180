...
To build the apk: `bazel clean --expunge && bazel build --config=android_arm64 -s java/com/google/vr180/app:camera --spawn_strategy=local --cxxopt="-I$JAVA_HOME/include" --cxxopt="-I$JAVA_HOME/include/linux"`
